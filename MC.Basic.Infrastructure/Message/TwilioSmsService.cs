...
public class TwilioSmsService : ITwilioSmsService
{
    ...
    public async Task<string> SendBatchRcsSms(MC.Basic.Application.Models.DataModel.TwilioMessageParams smsParams)
    {
        try
        {
            var accountSid = _accountSid;
    ...
    public async Task<string> SendBatchWhatsappSms(MC.Basic.Application.Models.DataModel.TwilioMessageParams smsParams)
    {
        var accountSid = _accountSid;
        var authToken = _authToken;
        TwilioClient.Init(accountSid, authToken);
